...
main:
  ...
  syscall           			# print the string
  				...
  				#Calculate perimeter
  add $11, $8, $8			#double width, store in $11
  add $12, $9, $9			#double height, store in $12
  add $13, $11, $12			#add products together
  
  
  				#Print "Its perimeter is"
  addi $v0, $0, 4  			# system call 4 is for printing a string
  la $a0, perimeterIs 			# address of perimiterIs string is in $a0
  syscall    
  
  				#Print the calculated perimeter (in $13)
  addi $v0, $0, 1			#system call 1 is for printing an integer
  add $a0, $0, $13			#bring the perimeter value from $13 into $a0
  syscall				#print the integer
